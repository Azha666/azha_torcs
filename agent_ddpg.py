...
BATCH_SIZE = 32  # 每次从经验池中随机抽取N=64条Transition
...
RESTORE_MODEL_PATH = '/home/azha/Torcs/azha_torcs/ckpt/model_ddpg_2_1318_185000.pth'  # 模型加载路径
        ...
        for i in range(MAX_EPISODE):
            ...
            for j in range(MAX_STEPS):
                ...
                if GLOBAL_STEP > 50000 and GLOBAL_STEP % 5000 == 0:
                    MODEL_PATH = '/home/qzw/PycharmProjects/my_torcs/ckpt/model_ddpg_2_' + str(
